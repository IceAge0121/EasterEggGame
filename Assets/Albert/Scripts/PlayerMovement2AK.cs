...
public class PlayerMovement2AK : MonoBehaviour
{
    ...
    {
        // Update the directions in which our camera container is facing.
    ...
    // Methods for checking inputs and controls logic.
    ...
    //private float ReturnHorizontalMagnitude(Vector3 input)
    //{
